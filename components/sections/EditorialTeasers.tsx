  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Link
          href="/shop"
          className="group relative overflow-hidden bg-white p-12 border border-elysium-whisper shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10 text-center">
            <div className="mb-6">
              <div className="w-16 h-16 mx-auto bg-elysium-gold rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        >
          ...
          <div className="relative z-10 text-center">
            <div className="mb-6">
              <div className="w-16 h-16 mx-auto bg-[#753600] rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
