...
function testAvelineMapping() {
  console.log('🧪 Testing Aveline Radiant Solitaire Product...\n');
  
  const product = getProductBySlug('aveline-radiant-solitaire');
  if (!product) {
    console.error('❌ Aveline product not found');
    return;
  }
